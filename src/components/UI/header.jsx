      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex space-x-1 xl:space-x-4">
            {navigation.map((item, idx) => (
              <a
                key={idx}
                href={item.path}
                className="text-gray-700 hover:text-yellow-600 px-2 xl:px-3 py-2 rounded-md text-sm font-medium flex items-center space-x-1 xl:space-x-2"
              >
                {item.icon}
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <a href="/login" className="px-2 xl:px-3 py-2 rounded-md text-xs xl:text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-500">
              <FaSignInAlt className="inline-block mr-1" /> Log in
            </a>
            <a href="/signup" className="px-2 xl:px-3 py-2 rounded-md text-xs xl:text-sm font-medium text-gray-700 hover:text-gray-900 border border-gray-200">
              <FaUserPlus className="inline-block mr-1" /> Sign up
            </a>
            <button onClick={toggleLanguage} className="px-2 xl:px-3 py-2 rounded-md text-xs xl:text-sm font-medium text-gray-700 hover:text-gray-900 border border-gray-200">
